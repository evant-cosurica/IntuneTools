# Script that performs the same task as setting up a GPO to enable autoenrollment into Intune of devices already joined to Azure AD through creation of
# the necessary reg key and scheduled task
